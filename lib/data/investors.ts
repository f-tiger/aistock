...
export const investors: Investor[] = [
  {
    ...
    holdings: [
      { ticker: 'AMZN', name: { zh: '亚马逊', en: 'Amazon' }, note: { zh: 'AWS 云 + AI 变现', en: 'AWS cloud + AI monetization' }, action: 'hold' },
      { ticker: 'AAPL', name: { zh: '苹果', en: 'Apple' }, note: { zh: '设备端 AI 与生态护城河', en: 'On-device AI and ecosystem moat' }, action: 'hold' },
    ],
  ...
  },
  {
    ...
    holdings: [
      { ticker: 'AMZN', name: { zh: '亚马逊', en: 'Amazon' }, note: { zh: '云 + AI 平台', en: 'Cloud + AI platform' }, action: 'add' },
      { ticker: 'CRWV', name: { zh: 'CoreWeave', en: 'CoreWeave' }, note: { zh: '纯 GPU 云', en: 'Pure-play GPU cloud' }, action: 'add' },
      { ticker: 'CBRS', name: { zh: 'Cerebras', en: 'Cerebras' }, note: { zh: 'AI 芯片新股', en: 'Newly public AI chip' }, action: 'new' },
  ...
  },
  {
    ...
    holdings: [
      { ticker: 'AMZN', name: { zh: '亚马逊', en: 'Amazon' }, note: { zh: '连续两季加仓', en: 'Added two quarters running' }, action: 'add' },
      { ticker: 'GOOGL', name: { zh: '谷歌', en: 'Alphabet' }, note: { zh: '全栈 AI + 估值相对合理', en: 'Full-stack AI at a relatively reasonable valuation' }, action: 'add' },
    ],
  ...
  },
  {
    ...
    holdings: [
      ...
      { ticker: 'PDD', name: { zh: '拼多多', en: 'PDD Holdings' }, note: { zh: '加仓，第四大重仓', en: 'Added — #4 holding' }, action: 'add' },
      { ticker: 'PLTR', name: { zh: 'Palantir', en: 'Palantir' }, note: { zh: '新建仓（AI 软件）', en: 'New position (AI software)' }, action: 'new' },
    ],
  ...
  },
  {
    ...
    holdings: [
      { ticker: 'AMZN', name: { zh: '亚马逊', en: 'Amazon' }, note: { zh: '近乎翻倍，第一大重仓', en: 'Nearly doubled — #1 holding' }, action: 'add' },
  ...
  },
  {
    ...
    holdings: [
      { ticker: 'NFLX', name: { zh: '奈飞', en: 'Netflix' }, note: { zh: '大幅加仓（+76%）', en: 'Sharply added (+76%)' }, action: 'add' },
      { ticker: 'META', name: { zh: 'Meta', en: 'Meta' }, note: { zh: '部分减持', en: 'Partly trimmed' }, action: 'trim' },
      { ticker: 'NVDA', name: { zh: '英伟达', en: 'Nvidia' }, note: { zh: '减持', en: 'Trimmed' }, action: 'trim' },
      { ticker: 'AMZN', name: { zh: '亚马逊', en: 'Amazon' }, note: { zh: 'AI 受益的核心成长股', en: 'Core AI-benefiting growth' }, action: 'hold' },
    ],
